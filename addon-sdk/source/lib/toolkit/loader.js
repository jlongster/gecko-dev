...
const load = iced(function load(loader, module) {
  let { sandboxes, globals, exportsHook } = loader;
  ...
  if(exportsHook) {
    module.exports = exportsHook(module.uri, module.exports, require);
  }
...
function Loader(options) {
  ...
  let returnObj = {
    ...
    exportsHook: { enumerable: false, value: options.exportsHook },
