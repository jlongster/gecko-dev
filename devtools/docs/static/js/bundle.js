...
/***/ function(module, exports, __webpack_require__) {
	...
	const components = __webpack_require__(1);
	const React = __webpack_require__(3);
	const ReactDOM = __webpack_require__(4);
	const Redux = __webpack_require__(5);

	module.exports = { components, React, ReactDOM, Redux };
	    ...
	    if (true) {
	      ...
	      if (inst.render == null) {
	        ...
	        // and stateless components, but not ES6 classes that don't extend
	         true ? warning(Component.isReactClass || !canInstantiate || !(inst instanceof Component), '%s(...): React component classes must extend React.Component.', Component.displayName || Component.name || 'Component') : undefined;
	      }
	    }
